...
<body>
    <div id="wrapper">
            ...
            <div class="header_wrap">
                <div class="header_inner mcontainer">
                    <div class="left_side">
                        ...
                        <div id="logo">
                            <a href="/"> 
                                <img src="assets/home//img/logo.svg" alt="">
                                <img src="assets/home//img/logo.svg" class="logo_mobile" alt="">
                            </a>
                        </div>
                    </div>
                  ...
                  <!-- search icon for mobile -->
                    ...
                    <div class="header_search"><i class="uil-search-alt"></i> 
                        <input value="" type="text" class="form-control" placeholder="Arkadaşlar,Videolar ve daha fazlasını arayın.." autocomplete="off">
                        <div uk-drop="mode: click" class="header_search_dropdown">
                            ...
                            <ul>
                                <li> 
                                    <a href="#">  
                                        <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" alt="" class="list-avatar">
                                ...
                                <ul class="dropdown_cart_scrollbar" data-simplebar>
                                    <li>
                                        <div class="cart_avatar">
                                            <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" alt="">
                                        </div>
                                        <div class="cart_text">
                            ...
                            <div uk-drop="mode: click" class="header_dropdown">
                                 <div  class="dropdown_scrollbar" data-simplebar>
                                     ...
                                     <ul>
                                         ...
                                         <li class="not-read">
                                             <a href="#">
                                                 <div class="drop_avatar status-online"> <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" alt="">
                                                 </div>
                                                 <div class="drop_text">
                                                     <p>
                                         ...
                                         <li>
                                             <a href="#">
                                                 <div class="drop_avatar"> <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" alt="">
                                                 </div>
                                                 <span class="drop_icon bg-gradient-primary">
                                                    <i class="icon-feather-thumbs-up"></i>
                                                </span>
        ...
        <div class="sidebar">
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul class="side_links" data-sub-title="Gençlik Otobüsü">
                    <li><a href="/"> <ion-icon name="settings-outline" class="side-icon"></ion-icon>  <span> Setting  </span> </a> 
                        <ul>
                    ...
                    <div class="lg:w-3/4 lg:px-20 space-y-7">
                        ...
                        <div class="card lg:mx-0 p-4" uk-toggle="target: #create-post-modal">
                            <div class="flex space-x-3">
                                ...
                                <input placeholder="Aklında ne var ?" class="bg-gray-100 hover:bg-gray-200 flex-1 h-10 px-6 rounded-full"> 
                            </div>
                        ...
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                            ...
                            <div class="flex justify-between items-center lg:p-4 p-2.5">
                                <div class="flex flex-1 items-center space-x-4">
                                    <a href="#">
                                        <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" class="bg-gray-200 border border-white rounded-full w-10 h-10">
                                    </a>
                                    <div class="flex-1 font-semibold capitalize">
                                        <a href="#" class="text-black dark:text-gray-100">Eray Arı</a>
                        ...
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                            ...
                            <div class="p-4 space-y-3"> 
                                ...
                                <div class="flex items-center space-x-3 pt-2"> 
                                    <div class="flex items-center">
                                        <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900">
                                        <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900 -ml-2">
                                        <img src="http://demo.foxthemes.net/socialitev2.2/assets/images/avatars/avatar-1.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900 -ml-2">
                                    </div>
                                    <div class="dark:text-gray-100">
                                        Liked <strong> Johnson</strong> and <strong> 209 Others </strong>
                    ...
                    <div class="lg:w-72 w-full">
                        ...
                        <a href="">
                            <div class="bg-white mb-5 px-4 py-3 rounded-md shadow">
                                <h3 class="text-line-through font-semibold mb-1">GO Genç Kart</h3>
                                <div class="-mx-2 duration-300 flex hover:bg-gray-50 px-2 py-2 rounded-md">
                                    <img class="img-responsive" src="http://genclikdunyasi.com/themes/sunshine/img/genc_kart.jpg">
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="" uk-sticky="offset:80">
                            ...
                            <nav class="responsive-nav border-b extanded mb-2 -mt-2">
                                <ul uk-switcher="connect: #group-details; animation: uk-animation-fade">
                                    <li class="uk-active"><a class="active" href="#0">Çevrimiçi<span>16</span> </a></li>
    ...
    <script src="../assets/home/js/tippy.all.min.js"></script>
    <script src="../assets/home/js/uikit.js"></script>
    <script src="../assets/home/js/simplebar.js"></script>
    <script src="../assets/home/js/custom.js"></script>
    <script src="../assets/home/js/bootstrap-select.min.js"></script>
